...
CREATE INDEX IF NOT EXISTS generation_outputs_favorite_idx ON generation_outputs(favorite);
CREATE INDEX IF NOT EXISTS interrogations_created_at_idx ON interrogations(created_at);
CREATE INDEX IF NOT EXISTS interrogations_asset_id_idx ON interrogations(asset_id);
CREATE INDEX IF NOT EXISTS interrogations_favorite_idx ON interrogations(favorite);
...
ensureColumn("generation_outputs", "favorite", "favorite INTEGER NOT NULL DEFAULT 0");
ensureColumn("interrogations", "favorite", "favorite INTEGER NOT NULL DEFAULT 0");
