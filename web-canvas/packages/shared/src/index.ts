...
export type ImageSizePresetId =
  | typeof AUTO_SIZE_PRESET_ID
  | (typeof SIZE_PRESETS)[number]["id"]
  | typeof CUSTOM_SIZE_PRESET_ID;
...
export interface InterrogateImageRequest {
  image: ReferenceImageInput;
}

export interface InterrogateImageResult {
